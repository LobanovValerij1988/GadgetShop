...
const models = require ('./Sequalize/Models') ;
...
models.GadgetType.bulkCreate(
  ...
  const user = {id: res.id, type: res.type}
  console.log(user);
}).catch(err=>console.log(err));
...
const sql=require("./Sequalize/createUser");
const myFunction=require("./Sequalize/serverFunction");
